/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings -e staging` (hash: 5475dc6903c77196689ef5532c5621d5)
// Runtime types generated with workerd@1.20251105.0 2024-10-22 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		SLACK_REFUND_WEBHOOK_URL: string;
		X_API_KEY: string;
		WEBSOCKET_API: Fetcher /* websocket-api-staging */;
		HYPERDRIVE: Hyperdrive;
		TICKET_CHECKOUT_WORKFLOW: Workflow<Parameters<import("./src/index").TicketCheckoutWorkflow['run']>[0]['payload']>;
		PAYMENT_COMPLETION_WORKFLOW: Workflow<Parameters<import("./src/index").PaymentCompletionWorkflow['run']>[0]['payload']>;
		TICKET_REFUND_WORKFLOW: Workflow<Parameters<import("./src/index").TicketRefundWorkflow['run']>[0]['payload']>;
	}
}
