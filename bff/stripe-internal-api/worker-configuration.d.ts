/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings -e staging` (hash: 0d62e3bb2d820c0c8e207e67c531a7ee)
// Runtime types generated with workerd@1.20250617.0 2025-07-15 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: "staging" | "production";
		STRIPE_API_KEY: string;
		PAYMENT_WORKFLOW_API: Fetcher /* payment-workflow-staging */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "STRIPE_API_KEY">> {}
}
