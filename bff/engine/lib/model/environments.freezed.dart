...
as String,cloudflareAccountId: null == cloudflareAccountId ? _self.cloudflareAccountId : cloudflareAccountId // ignore: cast_nullable_to_non_nullable
...
class _Environments extends Environments {
  const _Environments({required this.supabaseUrl, required this.supabaseServiceRoleKey, required this.cfVersionMetadataId, required this.cfVersionMetadataTag, required this.cfVersionMetadataTimestamp, required this.postgresUrl, required this.internalApiUrl, required this.xApiKey, required this.logoBaseUrl, required this.cloudflareAccountId, required this.r2BucketName, required this.r2AccessKeyId, required this.r2SecretAccessKey, required this.websocketJwtSecretBase64}): super._();
...
@override final  String cloudflareAccountId;
