/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings -e production -c wrangler.jsonc` (hash: 7aa60b5d3a2b5fe8d9bfaf0319c6ab44)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		X_API_KEY: string;
		PAYMENT_WORKFLOW_INTERNAL_API: Fetcher /* payment-workflow-internal-api-production */;
		STRIPE_INTERNAL_API: Fetcher /* stripe-internal-api-production */;
		R2_INTERNAL_API: Fetcher /* r2-internal-api-production */;
		PROFILE_SHARE_INTERNAL_API: Fetcher /* profile-share-internal-api-production */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "X_API_KEY">> {}
}
