/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 75d735c9cbe9b8ed03dc52b2dbf75878)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		TICKET_SALES_REPORTER: Workflow;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_WEBHOOK_URL" | "SLACK_SIGNING_SECRET">> {}
}
