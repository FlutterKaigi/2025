/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings -e staging` (hash: f37d05a75dc3596d0d8c765d7f989178)
// Runtime types generated with workerd@1.20251008.0 2025-10-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserWebsocketObject";
	}
	interface Env {
		JWT_PUBLIC_KEY: string;
		JWT_PRIVATE_KEY: string;
		X_API_KEY: string;
		USER_WEBSOCKET_OBJECT: DurableObjectNamespace<import("./src/index").UserWebsocketObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_PUBLIC_KEY" | "JWT_PRIVATE_KEY" | "X_API_KEY">> {}
}
