...
class _R2ApiClient implements R2ApiClient {
  _R2ApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<DeleteObjectResponse>> deleteObject({
    ...
    final _options = _setStreamType<HttpResponse<DeleteObjectResponse>>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/proxy/r2-internal-api/internal/r2/object',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeleteObjectResponse _value;
    try {
      _value = DeleteObjectResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
