...
mixin _$TicketStatusPayload {
 ...
 String get id; String get userId; String get ticketTypeId; TicketStatusType get status; DateTime get createdAt; DateTime get updatedAt; String? get stripePaymentIntentId; String? get nameplateId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,ticketTypeId,status,createdAt,updatedAt,stripePaymentIntentId,nameplateId);

@override
String toString() {
  return 'TicketStatusPayload(id: $id, userId: $userId, ticketTypeId: $ticketTypeId, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, stripePaymentIntentId: $stripePaymentIntentId, nameplateId: $nameplateId)';
}
...
@useResult
$Res call({
 String id, String userId, String ticketTypeId, TicketStatusType status, DateTime createdAt, DateTime updatedAt, String? stripePaymentIntentId, String? nameplateId
});
...
/// Create a copy of TicketStatusPayload
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? ticketTypeId = null,Object? status = null,Object? createdAt = null,Object? updatedAt = null,Object? stripePaymentIntentId = freezed,Object? nameplateId = freezed,}) {
...
as TicketStatusType,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String ticketTypeId,  TicketStatusType status,  DateTime createdAt,  DateTime updatedAt,  String? stripePaymentIntentId,  String? nameplateId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TicketStatusPayload() when $default != null:
return $default(_that.id,_that.userId,_that.ticketTypeId,_that.status,_that.createdAt,_that.updatedAt,_that.stripePaymentIntentId,_that.nameplateId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String ticketTypeId,  TicketStatusType status,  DateTime createdAt,  DateTime updatedAt,  String? stripePaymentIntentId,  String? nameplateId)  $default,) {final _that = this;
switch (_that) {
case _TicketStatusPayload():
return $default(_that.id,_that.userId,_that.ticketTypeId,_that.status,_that.createdAt,_that.updatedAt,_that.stripePaymentIntentId,_that.nameplateId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String ticketTypeId,  TicketStatusType status,  DateTime createdAt,  DateTime updatedAt,  String? stripePaymentIntentId,  String? nameplateId)?  $default,) {final _that = this;
switch (_that) {
case _TicketStatusPayload() when $default != null:
return $default(_that.id,_that.userId,_that.ticketTypeId,_that.status,_that.createdAt,_that.updatedAt,_that.stripePaymentIntentId,_that.nameplateId);case _:
  return null;
...
class _TicketStatusPayload implements TicketStatusPayload {
  const _TicketStatusPayload({required this.id, required this.userId, required this.ticketTypeId, required this.status, required this.createdAt, required this.updatedAt, this.stripePaymentIntentId, this.nameplateId});
...
/// Create a copy of TicketStatusPayload
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? ticketTypeId = null,Object? status = null,Object? createdAt = null,Object? updatedAt = null,Object? stripePaymentIntentId = freezed,Object? nameplateId = freezed,}) {
