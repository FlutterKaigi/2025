...
/// Create a copy of AuthMetaData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? avatarUrl = freezed,Object? name = null,}) {
  return _then(_self.copyWith(
...
class _AuthMetaData implements AuthMetaData {
  const _AuthMetaData({required this.email, this.avatarUrl, required this.name});
...
/// Create a copy of AuthMetaData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? avatarUrl = freezed,Object? name = null,}) {
