...
mixin _$Sessions {
 ...
 String get id; String get title; String get description;@RequiredDateTimeConverter() DateTime get startsAt;@RequiredDateTimeConverter() DateTime get endsAt; String get venueId; int? get sponsorId; bool get isLightningTalk; bool get isBeginnersLightningTalk; bool get isHandsOn; String? get videoUrl;@RequiredDateTimeConverter() DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,startsAt,endsAt,venueId,sponsorId,isLightningTalk,isBeginnersLightningTalk,isHandsOn,videoUrl,createdAt);

@override
String toString() {
  return 'Sessions(id: $id, title: $title, description: $description, startsAt: $startsAt, endsAt: $endsAt, venueId: $venueId, sponsorId: $sponsorId, isLightningTalk: $isLightningTalk, isBeginnersLightningTalk: $isBeginnersLightningTalk, isHandsOn: $isHandsOn, videoUrl: $videoUrl, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String title, String description,@RequiredDateTimeConverter() DateTime startsAt,@RequiredDateTimeConverter() DateTime endsAt, String venueId, int? sponsorId, bool isLightningTalk, bool isBeginnersLightningTalk, bool isHandsOn, String? videoUrl,@RequiredDateTimeConverter() DateTime createdAt
});
...
/// Create a copy of Sessions
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = null,Object? startsAt = null,Object? endsAt = null,Object? venueId = null,Object? sponsorId = freezed,Object? isLightningTalk = null,Object? isBeginnersLightningTalk = null,Object? isHandsOn = null,Object? videoUrl = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String description, @RequiredDateTimeConverter()  DateTime startsAt, @RequiredDateTimeConverter()  DateTime endsAt,  String venueId,  int? sponsorId,  bool isLightningTalk,  bool isBeginnersLightningTalk,  bool isHandsOn,  String? videoUrl, @RequiredDateTimeConverter()  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Sessions() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.startsAt,_that.endsAt,_that.venueId,_that.sponsorId,_that.isLightningTalk,_that.isBeginnersLightningTalk,_that.isHandsOn,_that.videoUrl,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String description, @RequiredDateTimeConverter()  DateTime startsAt, @RequiredDateTimeConverter()  DateTime endsAt,  String venueId,  int? sponsorId,  bool isLightningTalk,  bool isBeginnersLightningTalk,  bool isHandsOn,  String? videoUrl, @RequiredDateTimeConverter()  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _Sessions():
return $default(_that.id,_that.title,_that.description,_that.startsAt,_that.endsAt,_that.venueId,_that.sponsorId,_that.isLightningTalk,_that.isBeginnersLightningTalk,_that.isHandsOn,_that.videoUrl,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String description, @RequiredDateTimeConverter()  DateTime startsAt, @RequiredDateTimeConverter()  DateTime endsAt,  String venueId,  int? sponsorId,  bool isLightningTalk,  bool isBeginnersLightningTalk,  bool isHandsOn,  String? videoUrl, @RequiredDateTimeConverter()  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Sessions() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.startsAt,_that.endsAt,_that.venueId,_that.sponsorId,_that.isLightningTalk,_that.isBeginnersLightningTalk,_that.isHandsOn,_that.videoUrl,_that.createdAt);case _:
  return null;
...
/// Create a copy of Sessions
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? description = null,Object? startsAt = null,Object? endsAt = null,Object? venueId = null,Object? sponsorId = freezed,Object? isLightningTalk = null,Object? isBeginnersLightningTalk = null,Object? isHandsOn = null,Object? videoUrl = freezed,Object? createdAt = null,}) {
