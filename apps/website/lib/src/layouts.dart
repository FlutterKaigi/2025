...
HTMLElement basicLayout(HTMLElement child) => HTMLDivElement()
  ..style.display = 'flex'
...
HTMLElement get _header => HTMLElement.header()
  ..style.zIndex = '10'
  ..style.display = 'grid'
...
HTMLElement _languageLink(Language lang, String title) => user.lang == lang
    ? (HTMLLIElement()..textContent = title)
    : (HTMLLIElement()..append(
        internalLink(Text(title), path: currentPath.withLang(lang)),
      ));

HTMLElement get _footer => HTMLElement.footer()
  ..style.display = 'flex'
  ..style.flexDirection = 'column'
...
HTMLElement get _pastEvents => HTMLUListElement()
  ..style.display = 'flex'
  ..style.flexDirection = 'row'
  ..style.flexWrap = 'wrap'
  ..style.justifyContent = 'center'
  ...
  ..appendAll(
    event.pastEvents.map(
      (event) =>
          HTMLLIElement()..append(externalLink(event.title, url: event.url)),
    ),
  );

HTMLElement get _snsLinks => HTMLUListElement()
  ..style.display = 'flex'
  ..style.flexDirection = 'row'
  ..style.flexWrap = 'wrap'
  ..style.justifyContent = 'center'
...
HTMLElement get _externalLinks => HTMLUListElement()
  ..style.display = 'flex'
  ..style.flexDirection = 'row'
  ..style.flexWrap = 'wrap'
  ..style.justifyContent = 'center'
...
HTMLElement get _copyright => HTMLUListElement()
  ..style.display = 'flex'
  ..style.flexDirection = 'column'
  ..style.justifyContent = 'center'
  ..style.alignItems = 'center'
