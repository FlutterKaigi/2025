...
class L10nJa extends L10n {
  ...
  @override
  String get studentRefundTitle => '🎓 学生向け返金・費用補助について';

  @override
  String get studentRefundDescription =>
      'FlutterKaigi 2025では、学生支援スポンサー様のご協力により、学生チケットをご購入の方を対象に、以下の返金・費用補助を実施いたします。';

  @override
  String get studentRefundDetailsButton => '詳細を見る';
