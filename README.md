...
flutterkaigi-2025/
└── apps/
    ├── app/                # メインのカンファレンスアプリ (iOS/Android)
...
FlutterKaigi 2025 のメインアプリケーション (iOS/Android 対応)
...
- **オフライン対応**: ローカルキャッシュによる高速なデータアクセス
