...
INSERT INTO timeline_events (title, starts_at, ends_at, venue_id, url) VALUES
    ...
    -- 懇親会 (Room A)
    ('懇親会', '2025-11-13 18:30:00+09', '2025-11-13 20:30:00+09', 'e1a11efe-b1eb-43e1-ae60-9d2233e5dfe7', NULL),

    -- 懇親会 (Room B)
    ('懇親会', '2025-11-13 18:30:00+09', '2025-11-13 20:30:00+09', '0505c447-b699-4803-aab9-9cbdf9452c1b', NULL),
