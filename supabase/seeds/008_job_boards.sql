...
INSERT INTO job_boards (id, url, alt_text, image_name) VALUES
    ...
    (7, 'https://genda.jp/careers/', '株式会社GENDA 採用情報', 'genda.png'),
    (8, 'https://jobs.m3.com/engineer/', 'M3 エンジニアリンググループ : We''re App Developers!', 'm3.png'),
    (9, 'https://recruit.linc-well.com/engineer', '株式会社Linc''well 最高の医療体験を作りたい Flutter エンジニア募集', 'linkwell.png'),
    (10, 'https://youtrust.jp/companies/youtrust', 'YOUTRUST', 'youtrust.png'),
    (11, 'https://www.team-lab.com/recruit/career/flutter/', 'チームラボ Flutterエンジニア積極採用中！', 'teamlab.png'),
    (12, 'https://recruit.soda-inc.jp/', '株式会社SODA', 'soda.png'),
    (13, 'https://www.hacomono.co.jp/recruit/engineer/', '株式会社hacomono', 'hacomono.png');
